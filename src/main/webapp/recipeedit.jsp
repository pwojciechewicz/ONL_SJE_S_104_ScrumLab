            ...
            <form>
                ...
                <table class="table borderless">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-7">
                            <input class="w-100 p-1" name="name" value="${recipeName}" id="name">
                        </td>
                    </tr>
                    <tr class="d-flex">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-3">
                            <input class="p-1" type="number" name="preparation_time" id="preparation_time" value="${recipePreparationTime}">
                        </td>
                    </tr>
                    </tbody>
                </table>
